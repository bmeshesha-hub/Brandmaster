  ...
  return <div className={`app-shell ebay-theme unified-mode ${cleanTriage ? "clean-workflow" : "advanced-workflow"} view-${view}`}>
    ...
    <main aria-busy={Boolean(navigationTarget || navigationPending)}>
      ...
      <div className="page">
        ...
        {!LOCAL_MODE && view === "brand-cleanup" && <OnlineBrandCleanupV2 data={data} currentUser={currentUser} onSave={(brand) => saveCatalogBrand(brand, "BRAND_CLEANUP")} />}
...
function OnlineBrandCleanupV2({ data, currentUser, onSave }: { data: AppData; currentUser: string; onSave: (brand: CatalogBrand) => void }) {
