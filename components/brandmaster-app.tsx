...
function OnlineBrandCleanupV2({ data, currentUser, onSave, onSaveEnrichmentResource }: { data: AppData; currentUser: string; onSave: (brand: CatalogBrand) => void; onSaveEnrichmentResource: (rows: AppData["enrichmentResources"]) => void }) {
