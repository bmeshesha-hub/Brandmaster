  ...
  return <div className={`app-shell ebay-theme unified-mode ${cleanTriage ? "clean-workflow" : "advanced-workflow"} view-${view}`}>
    ...
    <main aria-busy={Boolean(navigationTarget || navigationPending)}>
      ...
      <div className="page">
        ...
        {LOCAL_MODE && view === "enrichment" && <BrandEnrichment />}
...
type EnrichmentCandidate = { id: string; currentName: string; suggestedName: string; currentAliases: string[]; suggestedAliases: string[]; removedAliases: string[]; reasons: string[]; confidence: number; decision?: "PENDING" | "APPROVE" | "REJECT"; evidence?: { url: string; title: string }[]; onlineStatus?: string };
