...
const children = [
  ...
  spawn(path.join(root, "node_modules", ".bin", "next"), ["dev", "--port", "3001"], { cwd: root, env: { ...process.env, BRANDMASTER_LOCAL_MODE: "true" }, stdio: "inherit", shell: process.platform === "win32" }),
];
